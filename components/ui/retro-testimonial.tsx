...
const Carousel = ({items, initialScroll = 0}: iCarouselProps) => {
	...
	return (
		<div className="relative w-full mt-10">
			<div
				className="flex w-full overflow-x-auto gap-4 snap-x snap-mandatory scroll-smooth py-5 -mx-4 px-4 [scrollbar-width:none]"
				ref={carouselRef}
						...
						return (
							<motion.div
								...
								animate={{
									...
									key={`card-${index}`}
									className="snap-start flex-shrink-0 last:pr-[5%] md:last:pr-[33%] rounded-3xl"
								>
